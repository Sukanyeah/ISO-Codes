/**
	* ISO-3166-1 codes.
	*
	* @package  Sukanyeah\ISO3166
	* @updated  March 26, 2023
	* @link     https://go.syah.in/iso-codes
	* @link     https://github.com/Sukanyeah/iso-codes
	*
	*/
CREATE TABLE `suk_iso_continents` (
	`id` INT(11) NOT NULL AUTO_INCREMENT COMMENT 'Continent ID',
...
INSERT INTO `suk_iso_continents` (`code`, `name`) VALUES
	('AF', 'Africa'),
	('AS', 'Asia'),
	('EU', 'Europe'),
	('NA', 'North America'),
...
CREATE TABLE `suk_iso_countries` (
	...
	CONSTRAINT `fk_countries_continents` FOREIGN KEY (`continent_code`) REFERENCES `suk_iso_continents` (`code`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

INSERT INTO `suk_iso_countries` (`code`, `continent_code`, `name`, `iso3`, `number`, `full_name`) VALUES
